...
<div id="logo" class="pull-left"><a><h1>
    <?php
    echo "Add Task Detail <br> for $taskName";
     ?>
  </a></h1>
 </div>
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="#">Add Task Detail </a></li>
    ...
    <div class="hero-container">
      <center><fieldset class="formm">
       ...
       <table class="table table-bordered table-dark">
         <form action='staffProcessTaskDetail.php' method='post' style='margin-top:35px' onsubmit= "return confirm('Confirm Submission?');">
         <th>
